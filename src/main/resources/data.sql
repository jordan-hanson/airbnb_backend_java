...
INSERT INTO users(userid, firstname, lastname, username, primaryemail, password, created_by, created_date, last_modified_by, last_modified_date)
    VALUES (1, 'TestUser', 'Utest', 'testuser', 'testuser@email.com', '$2y$12$PIEeCddpK7ubJhjazwhh9Oj59E8FURLTQSfzm90/UVjG725Z7b0nK', 'SYSTEM', CURRENT_TIMESTAMP, 'SYSTEM', CURRENT_TIMESTAMP),
           (2, 'TestRenter', 'Rtest', 'testrenter', 'testrenter@email.com', '$2y$12$PIEeCddpK7ubJhjazwhh9Oj59E8FURLTQSfzm90/UVjG725Z7b0nK', 'SYSTEM', CURRENT_TIMESTAMP, 'SYSTEM', CURRENT_TIMESTAMP),
           (3, 'TestOwner', 'Otest', 'testowner', 'testowner@email.com', '$2y$12$PIEeCddpK7ubJhjazwhh9Oj59E8FURLTQSfzm90/UVjG725Z7b0nK', 'SYSTEM', CURRENT_TIMESTAMP, 'SYSTEM', CURRENT_TIMESTAMP);
...
INSERT INTO cards(cardid, userid, name, number, type, expdate, securitycode, created_by, created_date, last_modified_by, last_modified_date)
    VALUES(1, 3, 'Utest TestUser', '3234567890', 'VISA', 0221, 123, 'SYSTEM', CURRENT_TIMESTAMP, 'SYSTEM', CURRENT_TIMESTAMP),
          (2, 2, 'Rtest TestRenter', '456789012345', 'DISCOVER', 0321, 321, 'SYSTEM', CURRENT_TIMESTAMP, 'SYSTEM', CURRENT_TIMESTAMP),
          (3, 1, 'Otest TestOwner', '345678901234', 'MASTERCARD', 4321, 432, 'SYSTEM', CURRENT_TIMESTAMP, 'SYSTEM', CURRENT_TIMESTAMP);
